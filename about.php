...
<form class="form-horizontal" method="POST" action="https://hashing24.com/authenticate" id="js-authenticate">
    ...
    <div class="js-auth_inputs js-auth_login">
        ...
        <div class="sign-in-social-icons">
            <a class="sign-in-social-icon" href="https://graph.facebook.com/oauth/authorize?client_id=1947287212159869&amp;response_type=code&amp;redirect_uri=https%3A%2F%2Fhashing24.com%2Foauth2%2Ffacebook%2Fcallback&amp;scope=email&amp;state=">
                <span class="fa-stack icon-social icon-fb">
                    <i class="fa fa-circle fa-stack-2x"></i>
                    <i class="fa fa-facebook fa-stack-1x fa-inverse"></i>
                </span>
            </a>
            <a class="sign-in-social-icon" href="https://accounts.google.com/o/oauth2/auth?scope=email&amp;state=&amp;response_type=code&amp;client_id=943004047393-oqqtc94hmntmej4ivvr25anb57j17lmc.apps.googleusercontent.com&amp;redirect_uri=https%3A%2F%2Fhashing24.com%2Foauth2%2Fgoogle%2Fcallback">
...
<h1>About Hashing24</h1>

<p class="default-p">Hashing24 was made by professionals for individuals who want to get involved in bitcoin mining. We believe that everyone should benefit from the mining and be able to have access the newest technologies and large scale industrial data centers from your laptop or mobile phone.</p>
<p class="default-p">The Hashing24 team has been involved in a mining business since 2012. We constantly explore the bitcoin market and we want to share our knowledge with you.</p>
<ul class="default-ul">
    <li>We stay informed on the major players in the bitcoin mining space.</li>
    <li>We constantly monitor new innovations and implement them for you.</li>
    <li>We choose the most reliable and reputable partners with the best equipment and data centers, which allows us to constantly increase selling capacities while providing our customers with the best opportunities.</li>
    <li>We ensure our partners provide warranties for their equipment and its maintenance, meaning we will hold them accountable for any disruption to your hosting for mining.</li>
    <li>We constantly evaluate new partners in order to provide you with the best speed, capacity and performance.</li>
</ul>
<p class="default-p">We cooperate with different mining companies. Our initial supplier of mining power is one of the industry’s leaders - BitFury.</p>
<p class="default-p">To learn more about our advantages, please see <a href='whyus.php'>Why use Hashing24</a>.</p>
...
<!-- Mirrored from hashing24.com/about by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Dec 2017 16:48:03 GMT -->
</html>
