  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
		<div class="modal-header">
	        ...
	        <small class="js_or-register-new">OR <a href="register.php">REGISTER NEW ACCOUNT</a></small><br/>
                <h5 class="js_or-register-new" id="regtxt" style="color:red"></h3>
                <!--<small class="js_or-register-new" id="regtxt"></small>-->
	    </div>
...
<div class="row">
    ...
    <div class="row form-group signin-button-wrapper">
        <div class="col-md-12">
            <button type="button" name="txtsign" id="btnsign" class="btn btn-primary col-md-12 js-signin" data-loading-text="Loading...">Sign In</button>
        
        
        </div>
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <center><h5 class="js_or-register-new" id="notmatch" style="color:red"></h5></center>
         <!--<small class="js_or-register-new" id="notmatch"></small>-->
          <!--<small class="js_or-register-new" id="regtxt"></small>-->
    </div>
<!--    <div class="row">
        <div class="col-md-12">
    ...
    if (Isvalidate())
     ...
     $.ajax
            ({
                ...
                data: {password:$('#txtpassword').val().trim(),email:$('#txtemail').val().trim()},
                success: function (data)
                {
                   
                    if(data.trim()=="1")
                    {
                   window.location.href = "PANEL/public/dashboard.php";
                    }
                    if(data.trim()=="2")
                    {
                          $('#notmatch').text("Please fill all fields");
                    }
                     if(data.trim()=="0")
                    {
                          $('#notmatch').text("Email and password doesn't match.");
