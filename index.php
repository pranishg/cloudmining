...
$('.j-change-lang').click(changeLang);
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html"><img alt="Hashing24" src="i/hashing-logo.png"></a>
		</div>
...
<form class="form-horizontal" method="POST" action="https://hashing24.com/authenticate" id="js-authenticate">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="index.html" class="btn btn-link js-reset_password" data-loading-text="Loading..."><small>I can&#39;t access my account</small></a>
        </div>
    </div>
    <div class="js-auth_inputs js-auth_verification display_none">
...
<div class="top-banner">
    <div class="container">
        ...
        <a href="tariffs.html" class="btn btn-warning top-banner-button margin-right-25">Start mining now</a>
    ...
    <div class="container">
        ...
        <div class="row margin-bottom-30 margin-top-25">
            ...
            <div class="col-sm-4">
                ...
                <h4 class="text-center step-title"><span class="step_badge">2</span> <a href="tariffs.html">Choose</a> your plan</h4>
            ...
            <div class="margin-top-40 text-center">
                <a href="tariffs.html" class="btn btn-transparent-orange top-banner-button">Start now</a>
            </div>
    </div>
</div>
...
<div class="why-profitable">
    <div class="container">
        ...
        WHY BITCOIN MINING IS profitable ?
            <a href="howitworks.html" class="btn btn-transparent w150 pull-right margin-top-8">Find out</a>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-5">
                ...
                <a href="tariffs.html" class="btn btn-warning top-banner-button margin-top-40">Start mining now</a>
            </div>
        </div>
    </div>
</div>
...
<a href="register.html" class="btn btn-warning top-banner-button margin-top-40">Join Us</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-1 col-md-10">
                ...
                <a href="support.html" class="btn btn-transparent-black top-banner-button margin-top-20">Contact us</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
      <div class="col-sm-4 article-preview article1">
        <div class="row">
          <div class="col-sm-12">
            ...
            <a class="article-title" href="whyus.html"><h4>Why use Hashing24?</h4></a>
            <p>Hashing24 is the best option<br/>available for users<br/>who want to mine bitcoin ...
            <a href="whyus.html">more</a>
            </p>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-4 article-preview article3">
        <div class="row">
          <div class="col-sm-12">
            <div class="center_article_block">
            <a class="article-title" href="howitworks.html"><h4>How does Hashing24 work?</h4></a>
            <p>Bitcoin mining has changed.<br />Today, for someone to mine and<br />get the same success ...
            <a href="howitworks.html">more</a>
            </p>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-4 article-preview article4">
        <div class="row">
          <div class="col-sm-12">
            <div class="center_article_block">
            <a class="article-title" href="index.html"><h4>Affiliate program</h4></a>
