    ...
    animation: fade .6s;
   	...
   	<div class="wrapper">
	    ...
	    <div class="main-panel">
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">GoUrl</a>
					</div>
            ...
            <div class="row">
            <br>
            <div align="right"><a href="https://gourl.io/info/memberarea/My_Account.html" target="_blank">Go to GoUrl</a><br></div>
<form action="" class="frmControl100" method="post" name="frmControl100" id="frmControl100">
<br>
  <h2 align="left">Keys</h2>
  <input name="txtPrvKy" type="text" id="txtPrvKy" value="<?Php echo $arbtcm1334; ?>" size="60" placeholder="Private_Key"  required ><label>Private_Key</label><br>
   <input name="txtPblKy" type="text" id="txtPblKy" value="<?Php echo $ardogem1334; ?>" size="60" placeholder="Public_Key"  required ><label>Public_Key</label><br>
      <input name="txtPblKys" type="text" id="txtPblKys" value="<?Php echo $ardogem13345; ?>" size="60" placeholder="webdev_key"  required ><label>webdev_key</label><br>
  <input name="btnPblKy" type="submit" id="btnPblKy" value="<?Php echo $Adm11; ?>"  title="Save"> <br>
</form>
       </div>
<br>
</div>
