...
.popup {
			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#"><?Php echo $Fq27; ?></a>
					</div>
  ...
  <form action="dltusr.php" class="frmUsers" method="post" name="frmUsers" id="frmUsers">
<br>
  <h2 align="left"><?Php echo $Fq25; ?> </h2>
  <input type="text" id="txtLogu" name="txtLogu" value="" size="40" placeholder="login"  required ><br>
   <input type="text" id="txtMailu" name="txtMailu" value="" size="40" placeholder="e-mail"  required ><br>
  <input type="submit" id="btnDelu" name="btnDelu" value="<?Php echo $Adm1; ?>"  title="Delete"> <br>
</form>
<br>
      </table>
      </div>
<?Php
$DBWithAll = mysql_query("SELECT * FROM gusers WHERE activation = '1' ");
$AdminAll = mysql_fetch_array($DBWithAll);
do
{
 printf("<p>Login: " .$AdminAll['glogin'] . " E-mail: " .$AdminAll['email'] . " IP: " .$AdminAll['IP'] ."</p>
    <p>Id: " .$AdminAll['id'] . "</p>---------<br/>");
}
while ($AdminAll = mysql_fetch_array($DBWithAll));
?>
	                            </div>
